...
<body>
        ...
        if(isset($_GET['order_id'])){
            ...
            $username_s = $row_food['username_s'];
            ...
            <div class="cards-confirmations">
                    ...
                    <div class="tile">
                    <input type="checkbox" name="picked_up" id="sport1" ' . ($checked_pickup? 'checked' : '') . '>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    checkboxes.forEach(checkbox => {
        checkbox.addEventListener('change', function () {
            ...
            // Send AJAX request to update_order_status.php with multiple query parameters
            const xhr = new XMLHttpRequest();
            xhr.open('POST', `update_order_status.php?orderID=${orderID}&shop_id=<?php echo $username_s; ?>`, true);
