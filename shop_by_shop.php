  ...
  <div id="container" class="container">
    ...
    <div id="food_container">
      ...
      <div id="food-items">
        ...
        <div id="shop-by-food">
          <p id="category-name">Explore your favorite restaurant</p>
          <?php
  
            include("database.php");

            // sent form previous script.
            $username_s = $_GET['username_s'];

            $sql = "SELECT * FROM menu WHERE username_s = '$username_s'";
